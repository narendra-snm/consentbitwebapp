...
/* build-hook-start *//*00001*/try { require('c:\\Users\\reshm\\.cursor\\extensions\\wallabyjs.console-ninja-1.0.524-universal\\out\\buildHook\\index.js').default({tool: 'next.js', checkSum: '20bc7454fa7b76f5890194U1UZBRsCXAdUUwRTUFZZDgIEXwID', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///c:/Users/reshm/.cursor/extensions/wallabyjs.console-ninja-1.0.524-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '20bc7454fa7b76f5890194U1UZBRsCXAdUUwRTUFZZDgIEXwID', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
