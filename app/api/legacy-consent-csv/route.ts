...
export async function GET(request: NextRequest) {
  ...
  const res = await serverFetch(`/api/legacy-consent-csv?${params.toString()}`, {
    method: 'GET',
    cookies: cookie,
  });
  ...
  return new Response(body, {
    ...
    headers: {
      ...
      'Content-Disposition': res.headers.get('Content-Disposition') || `attachment; filename="legacy_consent_${siteId}.xls"`,
    },
  });
}
