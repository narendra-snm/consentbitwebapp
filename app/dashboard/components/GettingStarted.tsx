...
const Headphones = ({ size = 16, className = "" }) => (
  <svg
  ...
  >
    ...
    <path d="M21 18a3 3 0 0 1-3 3h-1v-6h1a3 3 0 0 1 3 3z" />
    <path d="M3 18a3 3 0 0 0 3 3h1v-6H6a3 3 0 0 0-3 3z" />
  </svg>
);
...
const Paintbrush = ({ size = 16, className = "" }) => (
  <svg
    xmlns="http://www.w3.org/2000/svg"
    width={size}
    height={size}
    ...
    className={className}
  >
    <path d="M18 3a3 3 0 0 1 3 3c0 2-2 4-4 6l-5-5c2-2 4-4 6-4z" />
    <path d="M14 7l3 3" />
    <path d="M4 20c2 0 4-2 4-4 0-1.5-1-2-2-2s-2 .5-2 2c0 1-1 2-2 2s-2-1-2-2" />
  </svg>
);
