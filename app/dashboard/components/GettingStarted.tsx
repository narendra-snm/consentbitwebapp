    ...
    <div className="bg-gray-100 rounded-xl mt-5.5 px-6 py-6.5 grid grid-cols-[1fr_1.3fr_1.3fr_1fr] divide-x divide-gray-200">
      ...
      <div className="pr-6 flex flex-col">
        ...
        <div className="flex items-center gap-3 pt-5.75">
          <button className="bg-[#007AFF] text-white text-sm px-4 py-1.5 rounded-md">
            help Doc
          </button>

          <a className="flex items-center font-medium gap-1 text-[#007AFF] text-[15px] cursor-pointer">
