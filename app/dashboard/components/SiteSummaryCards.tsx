      ...
      <div className="bg-white border border-gray-200 rounded-xl p-5">
        ...
        <div className="grid grid-cols-4 gap-4 items-start">
          ...
          <div className="bg-[#FFEFEF]  col-span-2  rounded-lg py-3.75 px-3.5">  
            ...
            <p className="text-[#AC2734] font-medium text-xl mt-1 flex items-center gap-1">
              Inactive <svg width="12" height="14" viewBox="0 0 12 14" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <div className="text-xs text-gray-600 flex flex-col justify-between">
      ...
      <div>
        ...
        <p className="mt-1 text-sm text-[#161616]">
          February 25, 2025 21:12:57 (UTC+00:00)
        </p>
      </div>

      <div>
        <p className="text-[#4B5563]">Pages scanned</p>
        <p className="mt-1 text-sm text-[#161616]">01</p>
      </div>
