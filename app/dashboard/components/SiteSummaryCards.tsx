 ...
 return (
  <div className="grid grid-cols-2 gap-6 mt-4">
    ...
    <div className="bg-white border border-gray-200 rounded-xl p-5 flex flex-col">
      ...
      <div className="grid grid-cols-4 gap-4 items-start mb-2.75">
      ...
      {/* Footer */}
      {isLegacy ? (
        <div className="mt-auto bg-[#F3F4F6] rounded-lg py-6 px-3.5 flex items-center justify-between opacity-50 cursor-not-allowed">
          <span className="text-[#9CA3AF] text-sm">Customize cookie banner</span>
        </div>
      ) : (
        <Link
          href={siteId ? `/dashboard/${siteId}/cookie-banner` : "/dashboard"}
          className="mt-auto bg-[#EEF4FB] rounded-lg py-6 px-3.5 flex items-center justify-between"
        >
          <span className="text-[#007AFF] text-sm">Customize cookie banner</span>
          <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-arrow-right text-blue-600" aria-hidden="true">
            <path d="M5 12h14" />
