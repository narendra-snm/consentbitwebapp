...
export function BannerLinkSection() {
  ...
  const snippet = `data-consentbit-trigger`;
        ...
        <div className="flex items-center gap-2 px-[18px] py-4">
          ...
          <div className="relative group ml-1">
            ...
            <div className="pointer-events-none absolute bottom-full left-1/2 -translate-x-1/2 mb-2 w-56 bg-white border border-gray-200 shadow-md text-[#374151] text-[11px] leading-relaxed rounded-lg px-3 py-2 opacity-0 group-hover:opacity-100 transition-opacity z-50">
              Add this custom attribute to any existing link or button on your site so visitors can reopen the banner. Works in any framework (Webflow, Framer, WordPress, custom code, etc.).
        ...
        <div className="px-[18px] pb-5 space-y-3">
          ...
          <div className="relative">
            ...
            <button
              ...
              title={copied ? "Copied!" : "Copy attribute"}
            >
              {copied
          ...
          <p className="text-[11px] text-[#9CA3AF]">
            Add this attribute to any link or button element you already have. Clicking that element reopens the banner.
          </p>
        </div>
      </div>
    </div>
